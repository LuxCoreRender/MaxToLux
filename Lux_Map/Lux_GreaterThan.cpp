...
#define LUX_GREATERTHAN_CLASS_ID	Class_ID(0x7d03463, 0x4f3264d7)
...
class Lux_GreaterThan;

class Lux_GreaterThanSampler : public MapSampler
{
private:
	Lux_GreaterThan* mTexture;
public:
	Lux_GreaterThanSampler() : mTexture(nullptr) { }
	Lux_GreaterThanSampler(Lux_GreaterThan *c) { mTexture = c; }
	~Lux_GreaterThanSampler() { }

	void   Set(Lux_GreaterThan *c) { mTexture = c; }
...
class Lux_GreaterThan : public Texmap {
public:
	//Constructor/Destructor
	Lux_GreaterThan();
	virtual ~Lux_GreaterThan();
	...
	//From Animatable
	virtual Class_ID  ClassID() { return LUX_GREATERTHAN_CLASS_ID; }
	virtual SClass_ID SuperClassID() { return TEXMAP_CLASS_ID; }
	virtual void GetClassName(TSTR& s, bool localized) { s = GetString(IDS_CLASS_GREATERTHAN); }
...
class Lux_GreaterThanClassDesc : public ClassDesc2
...
public:
	...
	virtual void* Create(BOOL /*loading = FALSE*/) { return new Lux_GreaterThan(); }
	virtual const TCHAR *	ClassName() { return GetString(IDS_CLASS_GREATERTHAN); }
	const TCHAR*  NonLocalizedClassName() { return GetString(IDS_CLASS_GREATERTHAN); }
	virtual SClass_ID SuperClassID() { return TEXMAP_CLASS_ID; }
	virtual Class_ID ClassID() { return LUX_GREATERTHAN_CLASS_ID; }
	...
	virtual const TCHAR* InternalName() { return _T("Lux_GreaterThan"); }	// returns fixed parsable name (scripter-visible name)
	virtual HINSTANCE HInstance() { return hInstance; }					// returns owning module handle

};


ClassDesc2* GetLux_GreaterThanDesc() {
	static Lux_GreaterThanClassDesc Lux_GreaterThanDesc;
	return &Lux_GreaterThanDesc;
}


enum { Lux_GreaterThan_params };
...
static ParamBlockDesc2 Lux_GreaterThan_param_blk(Lux_GreaterThan_params, _T("params"), 0, GetLux_GreaterThanDesc(),
	P_AUTO_CONSTRUCT + P_AUTO_UI, PBLOCK_REF,
	//rollout
	IDD_GREATERTHAN_PANEL, IDS_GREATERTHAN_PARAMS, 0, 0, NULL,
	// params
	value1, _T("greaterthan value 1"), TYPE_FLOAT, P_ANIMATABLE, IDS_MIX_VALUE_1,
	p_default, 1.0f,
	p_range, 0.001f, 1.0f,
	p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_GREATERTHAN_VALUE_1, IDC_GREATERTHAN_VALUE_1_SPIN, 0.001f,
	p_end,

	texture1_map, _T("greater texture 1 map"), TYPE_TEXMAP, P_OWNERS_REF, IDS_CHECKER_TEXTURE1_MAP,
	p_refno, TEXTURE1_REF,
	p_subtexno, 0,
	p_ui, TYPE_TEXMAPBUTTON, IDC_GREATERTHAN_TEXTURE1_MAP,
	p_end,

	value2, _T("greaterthan value 2"), TYPE_FLOAT, P_ANIMATABLE, IDS_MIX_VALUE_1,
	p_default, 1.0f,
	p_range, 0.001f, 1.0f,
	p_ui, TYPE_SPINNER, EDITTYPE_FLOAT, IDC_GREATERTHAN_VALUE_2, IDC_GREATERTHAN_VALUE_2_SPIN, 0.001f,
	p_end,

	texture2_map, _T("greater texture 2 map"), TYPE_TEXMAP, P_OWNERS_REF, IDS_CHECKER_TEXTURE2_MAP,
	p_refno, TEXTURE2_REF,
	p_subtexno, 1,
	p_ui, TYPE_TEXMAPBUTTON, IDC_GREATERTHAN_TEXTURE2_MAP,
	p_end,
...
ParamDlg* Lux_GreaterThan::uvGenDlg;

//--- Lux_GreaterThan -------------------------------------------------------
Lux_GreaterThan::Lux_GreaterThan()
	: pblock(nullptr)
{
	for (int i = 0; i < NSUBTEX; i++)
		subtex[i] = nullptr;
	//TODO: Add all the initializing stuff
	GetLux_GreaterThanDesc()->MakeAutoParamBlocks(this);
	Reset();
}
...
void Lux_GreaterThan::Update(TimeValue /*t*/, Interval& /*valid*/)
{
	//TODO: Add code to evaluate anything prior to rendering
}

Interval Lux_GreaterThan::Validity(TimeValue /*t*/)
{
	//TODO: Update ivalid here
	return ivalid;
}

ParamDlg* Lux_GreaterThan::CreateParamDlg(HWND hwMtlEdit, IMtlParams* imp)
{
	IAutoMParamDlg* masterDlg = GetLux_GreaterThanDesc()->CreateParamDlgs(hwMtlEdit, imp, this);
...
BOOL Lux_GreaterThan::SetDlgThing(ParamDlg* dlg)
{
	if (dlg == uvGenDlg)
...
void Lux_GreaterThan::SetSubTexmap(int i, Texmap* m)
{
	ReplaceReference(i + 2, m);
	//TODO Store the 'i-th' sub-texmap managed by the texture
}

TSTR Lux_GreaterThan::GetSubTexmapSlotName(int i, bool localized)
{
...
//From ReferenceMaker
RefTargetHandle Lux_GreaterThan::GetReference(int i)
{
...
void Lux_GreaterThan::SetReference(int i, RefTargetHandle rtarg)
{
...
RefResult Lux_GreaterThan::NotifyRefChanged(const Interval& /*changeInt*/, RefTargetHandle hTarget, PartID& /*partID*/, RefMessage message, BOOL /*propagate*/)
{
	switch (message)
	{
...
RefTargetHandle Lux_GreaterThan::Clone(RemapDir &remap)
{
	Lux_GreaterThan *mnew = new Lux_GreaterThan();
...
Animatable* Lux_GreaterThan::SubAnim(int i)
{
...
TSTR Lux_GreaterThan::SubAnimName(int i, bool localized)
{
...
IOResult Lux_GreaterThan::Save(ISave* /*isave*/)
{
	//TODO: Add code to allow plug-in to save its data
	return IO_OK;
}

IOResult Lux_GreaterThan::Load(ILoad* /*iload*/)
{
	//TODO: Add code to allow plug-in to load its data
	return IO_OK;
}

AColor Lux_GreaterThan::EvalColor(ShadeContext& /*sc*/)
{
...
float Lux_GreaterThan::EvalMono(ShadeContext& sc)
{
	//TODO: Evaluate the map for a "mono" channel
	return Intens(EvalColor(sc));
}

Point3 Lux_GreaterThan::EvalNormalPerturb(ShadeContext& /*sc*/)
{
	//TODO: Return the perturbation to apply to a normal for bump mapping
	return Point3(0, 0, 0);
}

ULONG Lux_GreaterThan::LocalRequirements(int subMtlNum)
{
	//TODO: Specify various requirements for the material
	return uvGen->Requirements(subMtlNum);
}

void Lux_GreaterThan::ActivateTexDisplay(BOOL /*onoff*/)
{
	//TODO: Implement this only if SupportTexDisplay() returns TRUE
}

DWORD_PTR Lux_GreaterThan::GetActiveTexHandle(TimeValue /*t*/, TexHandleMaker& /*maker*/)
{
