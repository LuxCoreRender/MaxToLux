...
public:
	...
	virtual void GetClassName(TSTR& s) { s = GetString(IDS_CLASS_GREATERTHAN); }
...
TSTR Lux_GreaterThan::GetSubTexmapSlotName(int i)
{
...
TSTR Lux_GreaterThan::SubAnimName(int i)
{
