...
public:
	...
	virtual void GetClassName(TSTR& s) { s = GetString(IDS_CLASS_ADD); }
...
static ParamBlockDesc2 Lux_Divide_param_blk(Lux_Divide_params, _T("params"), 0, GetLux_DivideDesc(),
	...
	// params
	value1, _T("divide value 1"), TYPE_RGBA, P_ANIMATABLE, IDS_CHECKER_TEXTURE1_COLOR,
	...
	value2, _T("divide value 2"), TYPE_RGBA, P_ANIMATABLE, IDS_CHECKER_TEXTURE2_COLOR,
	p_default, Color(0.5f, 0.5f, 0.5f),
...
TSTR Lux_Divide::GetSubTexmapSlotName(int i)
{
...
TSTR Lux_Divide::SubAnimName(int i)
{
