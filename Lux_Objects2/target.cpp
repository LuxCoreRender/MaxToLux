...
//------------------------------------------------------
#define LUX_TARGET_CLASS_ID Class_ID(0x70da5334, 0x752a1a6c)

class TargetObjectClassDesc:public ClassDesc {
	public:
	int 			IsPublic() { return 0; }
	void *			Create(BOOL loading = FALSE) { return new TargetObject; }
	const TCHAR *	ClassName() { return GetString(IDS_TARGET); }
	const TCHAR*	NonLocalizedClassName() { return GetString(IDS_TARGET);	}
	SClass_ID		SuperClassID() { return GEOMOBJECT_CLASS_ID; }
	Class_ID		ClassID() { return LUX_TARGET_CLASS_ID; }
	const TCHAR* 	Category() { return GetString(IDS_PRIMITIVES);  }
	};
