...
extern ClassDesc2*	GetLuxLightPointDesc();
extern ClassDesc2*	GetLuxLightSphereDesc();
extern ClassDesc2*	GetTSpotLightDesc();
extern ClassDesc2*	GetTSkyLightDesc();
extern ClassDesc2*	GetTSunLightDesc();
extern ClassDesc2*	GetTLaserLightDesc();
...
{
	switch(i) {
		case 0: return GetLuxLightPointDesc();
		case 1: return GetLuxLightSphereDesc();
		case 2:	return GetTSpotLightDesc();
		case 3:	return GetTSkyLightDesc();
		case 4:	return GetTSunLightDesc();
		case 5:	return GetTLaserLightDesc();
		default: return 0;
	}
}
