...
#define LUX_POINT_LIGHT_CLASS_ID	Class_ID(0x2f4043ab, 0x2bf87bd2)
...
#ifdef PRIVATE_INCOMPATIBLE_OMNI_LIGHT
	Class_ID ClassID() 				{ return  type ? Class_ID(OMNI_LIGHT_CLASS_ID+type,0) : LUX_POINT_LIGHT_CLASS_ID; }  
#else	// !PRIVATE_INCOMPATIBLE_OMNI_LIGHT
	Class_ID ClassID() 				{ return  LUX_POINT_LIGHT_CLASS_ID; }
#endif	// !PRIVATE_INCOMPATIBLE_OMNI_LIGHT
	void 	GetClassName(TSTR& s) 	{ s = GetString(IDS_DB_LIGHT_CLASS); }
