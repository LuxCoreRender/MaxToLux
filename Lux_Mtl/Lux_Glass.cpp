...
public:
	...
	virtual void GetClassName(TSTR& s) {s = GetString(IDS_CLASS_GLASS);}
...
TSTR Lux_Glass::SubAnimName(int i)
{
...
TSTR Lux_Glass::GetSubMtlSlotName(int i)
{
...
TSTR Lux_Glass::GetSubTexmapSlotName(int i)
{
	switch (i)
	{
		case 0:
