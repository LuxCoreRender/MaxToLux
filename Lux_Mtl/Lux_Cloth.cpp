...
public:
	...
	virtual void GetClassName(TSTR& s, bool localized) {s = GetString(IDS_CLASS_CLOTH);}
...
public:
	...
	virtual const TCHAR*  NonLocalizedClassName()	{ return GetString(IDS_CLASS_CLOTH); }
	virtual SClass_ID SuperClassID() 				{ return MATERIAL_CLASS_ID; }
	virtual Class_ID ClassID() 						{ return LUX_Cloth_CLASS_ID; }
...
TSTR Lux_Cloth::SubAnimName(int i, bool localized)
{
...
TSTR Lux_Cloth::GetSubMtlSlotName(int i, bool localized)
{
...
TSTR Lux_Cloth::GetSubTexmapSlotName(int i, bool localized)
{
	switch (i)
	{
		case 0:
