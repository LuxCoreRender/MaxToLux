...
public:
	...
	virtual void GetClassName(TSTR& s, bool localized) {s = GetString(IDS_CLASS_ROUGH_MATTE);}
...
public:
	...
	virtual const TCHAR*  NonLocalizedClassName()	{ return GetString(IDS_CLASS_ROUGH_MATTE); }
	virtual SClass_ID SuperClassID() 				{ return MATERIAL_CLASS_ID; }
	virtual Class_ID ClassID() 						{ return LUX_ROUGH_MATTE_CLASS_ID; }
...
TSTR Lux_Rough_Matte::SubAnimName(int i, bool localized)
{
...
TSTR Lux_Rough_Matte::GetSubMtlSlotName(int i, bool localized)
{
...
TSTR Lux_Rough_Matte::GetSubTexmapSlotName(int i, bool localized)
{
	switch (i)
	{
		case 0:
