...
public:
	...
	virtual void GetClassName(TSTR& s) {s = GetString(IDS_CLASS_VELVET);}
...
TSTR Lux_Velvet::SubAnimName(int i)
{
...
TSTR Lux_Velvet::GetSubMtlSlotName(int i)
{
...
TSTR Lux_Velvet::GetSubTexmapSlotName(int i)
{
	switch (i)
	{
		case 0:
